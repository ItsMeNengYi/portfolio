...
export default function PythonLittleGame() {
    return <Page>
        <ContentContainer>
            <Stack spacing={2}>
                <BorderCard>
                    <Typography sx={title} variant="body1">Tic-Tac-Toe</Typography>
                ...
                <BorderCard>
                    <Typography sx={title}  variant="body1">2048</Typography>
                ...
                <BorderCard>
                    <Typography sx={title}  variant="body1">Hangman</Typography>
                ...
                <BorderCard>
                    <Typography sx={title}  variant="body1">Typing Test</Typography>
